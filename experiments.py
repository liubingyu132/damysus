...
numClTrans   = 100000     # number of transactions sent by each clients
...
def prepareCluster():
    ...
    for node in nodes:
        sshAdr = node["user"] + "@" + node["host"]
        prep_cmd = "cd " + node["dir"] + "; git clone https://github.com/liubingyu132/damysus.git; cd damysus; docker build -t damysus ."
